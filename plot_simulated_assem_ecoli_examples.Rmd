...
```{r}
sim_pa_files <- Sys.glob("./simulated_data/pipeline_assem_results/*_presence_absence.csv")
roary_inferred_pa_files <- Sys.glob("./simulated_data/pipeline_assem_results/*prokka_assem_roary_pa.csv")
panaroo_inferred_pa_files <- Sys.glob("./simulated_data/pipeline_assem_results/*prokka_assem_panaroo_pa.csv")
gene_annotations_files <- Sys.glob("./simulated_data/pipeline_assem_results/*assem_gene_data.csv")
```
...
mapping_df <- fread("./simulated_data/pipeline_assem_results/assem_mapping.csv", data.table = FALSE)
```
...
results_df
# write.csv(results_df, file = "assem_results.csv")
```
